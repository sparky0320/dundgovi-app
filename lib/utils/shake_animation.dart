...
class ShakeVerticalWidget extends StatefulWidget {
  const ShakeVerticalWidget({
    Key? key,
    required this.child,
    required this.shakeOffset,
    this.shakeCount = 3,
  ...
  @override
  ShakeVerticalWidgetState createState() => ShakeVerticalWidgetState(shakeDuration);
}

class ShakeVerticalWidgetState extends AnimationControllerState<ShakeVerticalWidget> {
  ShakeVerticalWidgetState(Duration duration) : super(duration);
