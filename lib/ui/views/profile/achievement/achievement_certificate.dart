...
class AchievementCertificate extends StatefulWidget {
  final String? image;
  final String? name;
  final int? kilo;
  ...
  @override
  State<AchievementCertificate> createState() => _AchievementCertificateState();
}

class _AchievementCertificateState extends State<AchievementCertificate>
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // SizedBox(height: 5.h),
                Text(
                  'Та ${widget.kilo} км алхаж "${widget.name}" цолоор шагнагдлаа. Үргэлжлүүлээд байгаарай',
