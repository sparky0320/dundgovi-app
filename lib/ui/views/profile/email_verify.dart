...
class EmailVerifyPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _EmailVerifyPageState();
}
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Таны ${widget.email} имэйл хаягт баталгаажуулах 4 оронтой код илгээсэн!',
                            style: TextStyle(
                              color: textGrey,
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        if (timerState.current == 0) {
                                          timerState.reset();
                                          timerState.startCountDown();
                                          ctrl.reSendSms(context, widget.email);
                                        } else {
                                          Get.snackbar("", "",
            ...
            ShakeWidget(
              ...
              child: Pinput(
                ...
                onCompleted: (pin) async {
                  await ctrl.doVerifyEmail(context, widget.email);
                },
              ),
            ),
